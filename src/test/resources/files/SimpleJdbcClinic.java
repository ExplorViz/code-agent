 ...
 * plus {@link SimpleJdbcInsert}. It also takes advantage of classes like {@link BeanPropertySqlParameterSource} and
 * {@link ParameterizedBeanPropertyRowMapper} which provide automatic mapping between JavaBean properties and JDBC
...
public class SimpleJdbcClinic implements Clinic, SimpleJdbcClinicMBean {
   ...
   * with the given name; also loads the {@link Pet Pets} and {@link Visit Visits} for the corresponding owners, if not
   * already loaded.
   */
  @Transactional(readOnly = true)
