...
public class MetricAppender { // NOPMD
  ...
  /**
   * Creates a MetricAppender to facilitate the access to the given {@link FileDataHandler}.
   *
   * @param fileDataHandler the fileDataHandler to wrap and access.
   */
  public MetricAppender(final FileDataHandler fileDataHandler) {
  ...
  /**
   * Gets the wrapped {@link FileDataHandler}. Keep in mind that some functionality of the
