...
/**
 * The MetricAppender is a helper Object to facilitate the adding of metric data
 * to the internal
 * FileData object. It provides basic functionality to keep track of the class
...
public class MetricAppender { // NOPMD
  ...
  /**
   * Creates a MetricAppender to facilitate the access to the given
   * {@link JavaFileDataHandler}.
   *
  ...
  /**
   * Sets the metric with metricName to metricValue. The metric is attached to the
   * current file.
   *
   * @param metricName  the name of the metric
   * @param metricValue the value of the metric
   * @return returns the old value of the metric if the metric exists, otherwise
   *         null
   */
   ...
   * @return returns the old value of the metric if the metric exists, otherwise
   *         null
   * @throws NotFoundException gets thrown if the class object was not found and
   *                           therefore the
   ...
   * @return returns the old value of the metric if the metric exists, otherwise
   *         null
   * @throws NotFoundException gets thrown if the method object was not found and
   *                           therefore the
   *                           metric could not be added
   */
  public String putClassMetric(final String metricName, final String metricValue,
   ...
   * {@link Verification#parameterHash(NodeList)}
  ...
  /**
   * Used to handle the tracking of the current class. Call with the current class
   * to use the
   * {@link MetricAppender#getClass()} and
   * {@link MetricAppender#getCurrentClassName()} anywhere
   * later. Enables the usability of
   * {@link MetricAppender#putMethodMetric(String, String)} and
   ...
   * @param parentFqn          the parent fqn, e.g the fqn of the method the
   *                           anonymous class is in
   */
  ...
  /**
   * Used to handle the tracking of the current method. Call with the current
   * method to use the
   * {@link MetricAppender#getCurrentMethodName()} anywhere later. Enables the
   * usability of
  ...
  /**
   * Used to handle the tracking of the current method. Call with the methodFqn to
   * use the
   * {@link MetricAppender#getCurrentMethodName()} anywhere later. Enables the
   * usability of
   * {@link MetricAppender#putMethodMetric(String, String)}.
   *
   * @param methodFqn the methodFqn, the user needs to make sure the fqn is
   *                  correct
   */
  ...
  /**
   * Gets the wrapped {@link JavaFileDataHandler}. Keep in mind that some
   * functionality of the
   * fileDataHandler is only avaible during the initial collection of data, use
   * with caution.
   *
